                ...
                <div class="panel-body">
                    ...
                    <table class="table table-bordered table-striped table-hover">
                        <thead>
                          <tr>
                            <th style="width:10%"> 
                              <form action="{{ route('sort.book') }}" method="GET" >
                                <input type="hidden" name="columnName" value="id">
                                <input type="hidden" name="sortBy" @if($columnName == 'id' && $sortBy == 'desc') value="asc" @else value="desc" @endif>
                                <button>ID @if($columnName == 'id' && $sortBy == 'desc') <i class="fas fa-sort-amount-up"></i> @else <i class="fas fa-sort-amount-down"></i> @endif</button>
                              </form>
                            </th>
                    ...
                    <ul class="pagination pagination-sm">
                        <li style="float: left;">
                            <a href="{{ url('/home/sortbook?columnName='.$columnName.'&sortBy='.$sortBy.'&page='.$page.'&items='.$items) }}" class="btn btn-sm btn-primary @if($isActive == $page) disabled @endif">First</a>
                        </li>
                        @for ($i = $allBooks->count(); $i > 0; $i-=$items)
                            <li class=" 
                                       ...
                                       <a href="{{ url('/home/sortbook?columnName='.$columnName.'&sortBy='.$sortBy.'&page='.$page.'&items='.$items) }}">{{ $page++ }}</a>
                            </li>
                        @endfor
                        <li>
                            <a href="{{ url('/home/sortbook?columnName='.$columnName.'&sortBy='.$sortBy.'&page='.--$page.'&items='.$items) }}" class="btn btn-sm btn-primary @if($isActive == $page) disabled @endif">Last</a>
                        </li>
                    </ul>                                      
                    <!-- pagination end -->
